...
scene_stage::binding_t general_render_stage::make_binding(
	const scene_stage_binding::msg& msg,
	const std::shared_ptr< scene >& scene )
{
	scene_stage::binding_t binding =
		_batching_system->make_binding( msg, scene );
...
const std::shared_ptr< scene_parameters_manager >& general_render_stage::
	scene_parameters_manager() const
{
	return _scene_parameters_manager;
}

const std::shared_ptr< batching_system >& general_render_stage::
	batching_system() const
{
