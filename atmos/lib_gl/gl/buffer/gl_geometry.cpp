...
//		}
//
//		vertex_buffers.push_back(ASSERT_CAST(gl_vertex_buffer*,
// vertex_buffer.get()));
//	}
//
...
// vao needs to get moved to geometry_batch, batch system nodes need to be
// allowed to have platform dependent implementations
//	if (vao)
//	{
...
// vertex_buffer->gl_format().attributes())
//			{
