...
parameter_block_bindings::parameter_block_bindings(const parameter_block& parameter_block)
...
const std::vector<parameter_binding>& parameter_block_bindings::parameter_bindings(const igpu::program& program)
{
    const auto program_binding_id = program.binding_id();
    const auto parameter_block_binding_id = _parameter_block.binding_id();
    
    if(program_binding_id != _program_binding_id || parameter_block_binding_id != _parameter_block_binding_id)
    {
