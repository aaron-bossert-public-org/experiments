...
std::string debug::to_stages_string( VkPipelineStageFlags stages )
{
	...
	std::pair< VkPipelineStageFlags, const char* > pairs[] = {
...
std::string debug::to_access_string( VkAccessFlags stages )
{
	std::string result;

	std::pair< VkAccessFlags, const char* > pairs[] = {
		...
		{ VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX,
		  "COMMAND_PROCESS_READ_BIT_NVX" },
		{ VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX,
		  "COMMAND_PROCESS_WRITE_BIT_NVX" },
