...
//    
//	auto gl_render_target = ASSERT_CAST(igpu::gl_render_target*, render_target.get());
...
//        {
//            return std::unique_ptr<gl_draw_target>(new gl_draw_target(frame_buffer, render_target, depth_target));
//        }
//    }
//    
