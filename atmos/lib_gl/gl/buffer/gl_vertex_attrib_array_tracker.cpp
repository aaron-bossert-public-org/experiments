...
//}
//
// void gl_vertex_attrib_array_tracker::state_caching_enabled(bool
// state_caching_enabled)
//{
//    // Enable state caching to avoid unnecessary calls to
//    glVertexAttribPointer.
//    // Disable state caching when there is a chance of contaminating the
//    cached view of
//    // glVertexAttribPointer state through external invocations of GL code (eg
//    Scaleform).
//
...
//            &enabled); ASSERT_CONTEXT(!enabled);
//        }
//#endif
//    }
//}
...
//}
//
// void gl_vertex_attrib_array_tracker::set_active_vertex_buffers(const
// gl_geometry& geometry)
//{
//    for(const auto& vertex_buffer : geometry.cfg().vertex_buffers)
//    {
//		const gl_vertex_buffer* gl_v_buffer = (const
// gl_vertex_buffer*)vertex_buffer.get();
//        glBindBuffer(GL_ARRAY_BUFFER, gl_v_buffer->gl_handle());
//
//		for (const gl_vertex_attribute& attribute :
// gl_v_buffer->gl_format().attributes())
//		{
//			if (!_state_caching_enabled)
//			{
...
//			}
//
//			// Tracking and avoiding redundantly setting this state is not
// effective because it
//			// binds the current GL_ARRAY_BUFFER to the given attribute pointer
// index. 			glVertexAttribPointer( 				attribute.location,
...
//    if(_state_caching_enabled)
//    {
//        // Disable elements that were left in enabled state after previous
//        call to this function for(GLint index : _enabled_arrays)
//        {
...
//        }
//
//		// Mark elements for disable so they can be disabled if not enabled
// after the next call to this function 		for (size_t index :
// _next_enabled_arrays)
//		{
