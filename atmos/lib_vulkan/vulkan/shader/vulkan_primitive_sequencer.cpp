...
//
// bool vulkan_primitive_sequencer::reset(
//	const vulkan_parameters& vulkan_parameters,
//	const vulkan_primitives& vulkan_primitives )
//{
//	_binding_description_count = 0;
//	if ( !_basic_indexer.reset( vertex_parameters, geometry ) )
//	{
//		return false;
//	}
//
...
//		const auto& source = _basic_indexer.indices()[i];
//
//		const auto& buff_cfg =
...
//
//
// const attribute_indexer& vulkan_primitive_sequencer::indexer() const
//{
//	return _indexer;
//}
//
// uint32_t vulkan_primitive_sequencer::binding_description_count() const
//{
//	return _binding_description_count;
//}
//
// const VkVertexInputBindingDescription* vulkan_primitive_sequencer::
//	binding_descriptions() const
//{
//	return _binding_descriptions.data();
//}
//
// const VkVertexInputAttributeDescription* vulkan_primitive_sequencer::
