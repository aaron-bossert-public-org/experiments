...
private:
	...
	struct new_geo_impl
	{
		...
		void draw(VkCommandBuffer command_buffer)
		{
			...
			vkCmdBindIndexBuffer(command_buffer, index_buffer.gpu_resource().get(), 0, index_buffer.cfg().vk.format);
			vkCmdBindVertexBuffers(command_buffer, 0, 1, vertex_buffers, offsets);
			vkCmdDrawIndexed(command_buffer, (uint32_t)vulkan->index_buffer().element_count(), 1, 0, 0, 0);
		}
...
private:
	...
	void create_graphics_pipeline()
	{
		...
		vkCreateGraphicsPipelines(_device, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &_graphics_pipeline);
	}
