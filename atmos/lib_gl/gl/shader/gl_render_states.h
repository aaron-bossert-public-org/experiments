...
#pragma pack(push, 1)
    struct gl_cull_mode
    {
		static gl_cull_mode gl_cull_mode::make(const cull_mode& mode, bool* success =  nullptr);
    ...
    {
		static gl_blend_mode gl_blend_mode::make(const blend_mode&, bool* success = nullptr);
    ...
    {
		static gl_depth_mode gl_depth_mode::make(const depth_mode&, bool* success = nullptr);
    ...
    {   
		static gl_stencil_mode gl_stencil_mode::make(const stencil_mode&, bool* success = nullptr);
    ...
    {
		static gl_packed_states gl_packed_states::make(const render_states::config&, bool* success = nullptr);
