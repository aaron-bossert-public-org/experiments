...
void vulkan_instance_batch::base_vertex(const std::optional < ptrdiff_t >& base_vertex)
{
	_base_vertex = base_vertex;
}

void vulkan_instance_batch::instance_start(const std::optional < size_t >& instance_start)
{
...
void vulkan_instance_batch::visibility_sphere(const std::optional < utility::sphere >& visibility_sphere)
{
...
const std::optional < utility::sphere >& vulkan_instance_batch::visibility_sphere() const
{
