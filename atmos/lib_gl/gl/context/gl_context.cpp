...
//}
//
//void gl_context::set_render_states(const gl_render_states* render_states, bool force)
//{
//#if ATMOS_PERFORMANCE_TRACKING
//	_renderstate_switch_metric.add(1);
//#endif
...
//}
//
//// provided macro for testing if states have changed, and updating existing value
...
//        glStencilFunc(stencil_mode.compare, stencil_mode.ref, stencil_mode.read_mask);
//        glStencilOp(stencil_mode.fail, stencil_mode.depth_fail, stencil_mode.pass);
//    }
//    else
//    {
...
//}
//
//const gl_vertex_attrib_array_tracker& gl_context::vertex_attrib_array_tracker() const
//{
...
//        
//        glGetRenderbufferParameteriv(GL_RENDERBUFFER, GL_RENDERBUFFER_WIDTH, &viewport.w);
//        glGetRenderbufferParameteriv(GL_RENDERBUFFER, GL_RENDERBUFFER_HEIGHT, &viewport.h);
//        
...
//}
//
//void gl_context::clear(const glm::vec4* color, const float* depth, const uint8_t* stencil)
//{
//#if ATMOS_PERFORMANCE_TRACKING
...
//#endif
//
//    ASSERT_CONTEXT(target, "gl_context::setDrawTarget(target) failed, target is null");
//    if (nullptr != target)
//    {
...
//
//#if ATMOS_DEBUG
//	size_t index_count = _active_geometry_info.geometry->cfg().index_buffer->byte_capacity() / _active_geometry_info.bytes_per_index;
