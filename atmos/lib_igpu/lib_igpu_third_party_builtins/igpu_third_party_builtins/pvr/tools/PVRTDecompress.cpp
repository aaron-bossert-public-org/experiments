...
*************************************************************************/
inline Pixel32 getColourA(PVRTuint32 u32ColourData)
{
	Pixel32 colour;
...
*************************************************************************/
inline Pixel32 getColourB(PVRTuint32 u32ColourData)
{ 
	Pixel32 colour;
...
*************************************************************************/
inline void interpolateColours(Pixel32 P, Pixel32 Q, Pixel32 R, Pixel32 S,
...
*************************************************************************/
inline void unpackModulations(const PVRTCWord& word, int offsetX, int offsetY, PVRTint32 i32ModulationValues[16][8], PVRTint32 i32ModulationModes[16][8], PVRTuint8 ui8Bpp)
{	
...
*************************************************************************/
inline PVRTint32 getModulationValues(PVRTint32 i32ModulationValues[16][8],PVRTint32 i32ModulationModes[16][8],PVRTuint32 xPos,PVRTuint32 yPos,PVRTuint8 ui8Bpp)
{
	if (ui8Bpp==2)
	{
...
*************************************************************************/
inline unsigned int modifyPixel(int red, int green, int blue, int x, int y, unsigned int modBlock, int modTable)
{
...
*************************************************************************/
inline int ETCTextureDecompress(const void * const pSrcData, const int &x, const int &y, const void *pDestData,const int &/*nMode*/)
{
