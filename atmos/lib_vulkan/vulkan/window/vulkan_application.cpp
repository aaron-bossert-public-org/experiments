...
//		}
//
//		if ( vkCreateInstance( &create_info, nullptr, &_instance ) !=
//			 VK_SUCCESS )
//		{
...
//		{ 			throw std::runtime_error("failed to create swap
// chain!");
//		}
//
...
//		{
//			_swap_chain_image_views[i] = create_image_view(
...
//			read_file( "cooked_assets/shaders/shader.vert.spv" );
//		auto frag_shader_code =
//			read_file( "cooked_assets/shaders/shader.frag.spv" );
//
...
//			_color_image,
//			_color_image_memory );
//		_color_image_view = create_image_view(
//			_color_image,
//			color_format,
//			VK_IMAGE_ASPECT_COLOR_BIT,
//			1 );
...
//		_mip_levels = static_cast< uint32_t >( std::floor(
...
//
//		VkSampleCountFlags counts = std::
//			min( physicalDeviceProperties.limits.framebufferColorSampleCounts,
...
//
//		if ( vkCreateImage( _device, &image_info, nullptr, &image ) !=
//			 VK_SUCCESS )
//		{
...
//
//		if ( vkAllocateMemory( _device, &alloc_info, nullptr, &imageMemory ) !=
//			 VK_SUCCESS )
...
//			static_cast< uint32_t >( _swap_chain_images.size() );
...
//			layouts( _swap_chain_images.size(), _descriptor_set_layout );
...
//
//		if ( vkCreateBuffer( _device, &buffer_info, nullptr, &buffer ) !=
//			 VK_SUCCESS )
...
//			find_memory_type( memRequirements.memoryTypeBits, properties );
//
//		if ( vkAllocateMemory( _device, &alloc_info, nullptr, &bufferMemory ) !=
//			 VK_SUCCESS )
...
//
//			if ( vkBeginCommandBuffer( _command_buffers[i], &beginInfo ) !=
//				 VK_SUCCESS )
...
//		vkMapMemory(
//			_device,
//			_uniform_buffers_memory[currentImage],
//			0,
//			sizeof( ubo ),
//			0,
//			&data );
...
// VkDebugUtilsMessageTypeFlagsEXT /* message_type */, const
// VkDebugUtilsMessengerCallbackDataEXT* p_callback_data, void* /* p_user_data
//*/)
//	{
