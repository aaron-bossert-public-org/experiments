...
//
//    std::vector<std::string> split_shader_source_lines(const buffer_view_base&
//    source_code)
//    {
...
//        glGetShaderInfoLog(shader, k_info_log_max_length, &info_log_length,
//        info_log);
//
//        std::vector<std::string> source_lines =
//        split_shader_source_lines(source_code);
//
//        std::string err_desc = make_error_desc(std::string(info_log,
//        info_log_length), source_lines); std::string line_numbered_shader_code
//        = make_line_numbered_source(source_lines);
//
//		LOG_CRITICAL( "%s\n%s\n\n%s", err_desc.c_str(),
...
//	}
//
//    bool gl_link_program(GLuint program, GLuint vertex_program, GLuint
//    pixel_program)
//    {
//        bool success = true;
//
...
//}
//
// bool gl_compile_shader_code(GLuint shader, const buffer_view_base&
// source_code)
//{
...
//				bool success = false;
//
//				bind_vertex_attribute_indices(cfg.context->vertex_constraints(),
// program_handle);
//
//				if(gl_link_program(program_handle, vertex_handle,
// fragment_handle))
//				{
//					success = true;
//				}
