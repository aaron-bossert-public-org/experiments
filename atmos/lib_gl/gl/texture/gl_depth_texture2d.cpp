...
//}
//
// std::unique_ptr<gl_depth_texture2d> gl_depth_texture2d::make(const config&
// cfg)
//{
...
//
//	glTexImage2D(GL_TEXTURE_2D, 0, internal_format, cfg.res.x, cfg.res.y, 0,
// format, type, nullptr);
//
...
//
//	return std::unique_ptr<gl_depth_texture2d>(new gl_depth_texture2d(cfg,
// gl_handle));
//}
//
...
//, _gpu_mem_metric(perf::category::GPU_MEM_USAGE, "GPU Depth Texture Buffer
// Mem")
//{
