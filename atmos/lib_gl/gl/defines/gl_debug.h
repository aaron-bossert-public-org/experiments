...
public:
    ...
    void set_errors_enabled(bool enabled, const char* reason, const char* func, const char* file, unsigned line);
    
    bool check_for_errors(const char* gl_func, const char* args_str, const char* func, const char* file, unsigned line, logging::severity);
